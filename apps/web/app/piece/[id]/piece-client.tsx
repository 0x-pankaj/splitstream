/** Client half of the shareable single-piece page — the interactive catalog +
 *  unlock flow. The server `page.tsx` wrapper supplies `id` and the social/OG
 *  metadata so shared links render a rich preview. */
